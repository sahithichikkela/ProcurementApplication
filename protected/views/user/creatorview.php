...
<button class="btn btn-primary pull-right ml-5" ><a style="color:white" href="<?php echo $this->createUrl('index.php/ticket/reopenticket', array('id' => $data->id)); ?>"> Re-open Ticket</a></button>
...
<button class="btn btn-danger pull-right ml-5" > The ticket is on HOLD</button>
