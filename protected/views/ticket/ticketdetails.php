...
<?php
        if ($data->escalated_to!="none"){ ?>

<button class="btn btn-danger pull-right ml-5" >This ticket was escalated to <?php echo $data->escalated_to ?></button>
...
<div>
    ...
    <div class="comments">
        ...
        if (!empty($data->comments) && $data->comments!='')
        {
            foreach ($data->comments as $comment): if($comment !='') {?>
