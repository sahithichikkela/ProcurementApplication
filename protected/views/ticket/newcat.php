...
<section class="vh-1000 " style="padding-left:200px">
  <div class="container py-5 h-150">
      ...
      <div class="col-12 col-lg-9">
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          <div class="card-body p-4 p-md-5">
            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 " style="text-align:center">Create new category</h3>
    ...
    <div class="">
    <?php echo $form->labelEx($model,'Category',array("class"=>'labels')); ?>
...
<div class="">
    <?php echo $form->labelEx($model,'Category code',array("class"=>'labels')); ?>
    <div class="form-outline">
        <?php echo $form->textField($model,'code',array("class"=>'form-control')); ?>
    </div>
    <?php echo $form->error($model, 'code', array("class" => 'error-message')); ?>
</div>
...
<div class="">
    <?php
    echo $form->labelEx($model, 'Escalate to', array("class" => 'labels'));
    echo $form->dropDownList($model, 'escalate_to', $userNames, array(
        'id' => 'escalate_to',
        'class' => 'form-control',
        'empty' => 'Select email',
    ));
    
    echo $form->error($model, 'escalate_to', array("class" => 'error-message'));
    echo "<br>";
    ?>
</div>
